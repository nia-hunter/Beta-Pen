...
public:HistoManager();
  ...
  void FillIrishExit(std::vector<G4double> sneak_x, std::vector<G4double> sneak_y, std::vector<G4double> sneak_z, std::vector<G4double> sneak_e);   
  void FillTOT(std::vector<G4double> ToT_E);
private:
  G4bool fFactoryOn;
    std::ofstream fout;
};
